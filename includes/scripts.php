...
var num = 1;
while (num <= <?php echo $m; ?>) {
    document.querySelector('#multi_ay' + num).addEventListener('change', function() {
        var ay_id = this.value;
        document.cookie = "ay=" + ay_id;
    });
...
var num = 1;
while (num <= <?php echo $m; ?>) {
    document.querySelector('#multi_sem' + num).addEventListener('change', function() {
        var sem_id = this.value;
        document.cookie = "sem=" + sem_id;
    });
...
document.querySelector('.multi_ay').addEventListener('change', function() {
    var ayID = this.value;
    document.cookie = "ay=" + ayID;
});
document.querySelector('.multi_sem').addEventListener('change', function() {
    var semID = this.value;
    document.cookie = "sem=" + semID;
});
</script>
<script>
