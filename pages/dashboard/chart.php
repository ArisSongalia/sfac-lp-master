                    ...
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header m-1 my-0">
                            <div class="row justify-content-between">
                                <div class="col-md-4 my-auto  mt-2">
                                    ...
                                    echo '<b>'. $get_ay['academic_year'] .'</b> to <b>'. $_SESSION['AC'] . '</b>';
                                ...
                                $index = 0;
                                $get_ay = mysqli_query($db,"SELECT * FROM tbl_acadyears WHERE academic_year NOT IN ('') AND academic_year <= '$_SESSION[AC]' ORDER BY academic_year ASC");
                                ...
                                <div class="col-sm-auto mt-2">
                                    ...
                                    <button class="btn bg-gradient-dark mx-1">
                                        Total Student <br>
                                        <?php echo $_SESSION['S'] .', '. $ay_array[$index - 2]; ?> :<br><span class="h3 text-white"><?php echo ($_SESSION['S'] == 'First Semester') ? $student_array[$index - 2] : $student_array2[$index - 2]; ?></span>
                                
                                    </button>
                                    <button class="btn bg-gradient-light mx-1">
                                        Total Student <br>
                                        <?php echo $_SESSION['S'] .', '. $ay_array[$index - 1]; ?> :<br><span class="h3 text-dark"><?php echo ($_SESSION['S'] == 'First Semester') ? $student_array[$index - 1] : $student_array2[$index - 1]; ?></span>
                        ...
                        <div class="table-responsive px-4 my-4">
                            <div class="card mx-2">
                                ...
                                <h6>First and Second Semester Comparison</h6>
                                <p class="text-sm">
                                    <b><?php
                                    if ($_GET['dep'] == "All" || $_GET['dep'] == "Old" || $_GET['dep'] == "New") {
                                        echo "for ". $_GET['dep']. " Students.";
                                    } else {
                                    echo "for ". $rowdep['department_name']. " Students.";
                                    }?></b>
                                </p>
                                </div>
