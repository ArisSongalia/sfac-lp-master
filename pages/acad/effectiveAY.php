...
?>
<title>
    Effective Curriculum Year | SFAC - Las Piñas
</title>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">Effective Curriculum Year</h6>
            ...
            <div class="row mb-8">
                <div class=" col-lg-4 col-12 mx-auto">
                    <div class="card card-body mt-4 shadow-sm">
                        <h5 class="font-weight-bolder mb-0">Add Effective Curriculum Year</h5>
                        ...
                        <form method="POST" enctype="multipart/form-data" action="acadData/ctrl.effectiveAY.php">
                            <div class="row justify-content-center">
                                <div class="col-sm-10 text-center">
                                    <label>Effective Curriculum Year</label>
                ...
                <div class="col-lg-8">
                    <div class="card shadow shadow-xl mt-4">
                        ...
                        <div class="card-header">
                            <h5 class="mb-0 font-weight-bolder">Effective Curriculum Years List</h5>
                            <p class="text-sm mb-0">
                                This is a list of Effective Curriculum Year
                            </p>
                        </div>
