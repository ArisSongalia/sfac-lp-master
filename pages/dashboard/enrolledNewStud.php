...
?>
<title>
    Enrolled New Students | SFAC - Las Piñas
</title>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View Enrolled New Students</h6>
                ...
                <div class="col-12">
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header m-1 my-0">
                            <h5 class="mb-0 ">Enrolled New Students List</h5>
                        ...
                        <div class="row mx-2 d-flex justify-content-center">
                            <div class="col mt-3 justify-content-center">
                                ...
                                while ($row = mysqli_fetch_array($information)) {
                                    ...
                                    WHERE remark IN ('Approved')
                                    AND status = 'New'
                                    AND ay_id IN ('$_SESSION[AC]')
                                    AND sem_id IN ('$_SESSION[S]')
                                    AND info_id = '$row[info_id]'") or die (mysqli_error($db));
