...
if ($_SESSION['role'] == "Super Administrator" || $_SESSION['role'] == "Registrar" || $_SESSION['role'] == "Adviser") {
            ...
            <div class="col-lg-11 mt-lg-0 mt-4 mx-auto">
                ...
                <div class="card card-body" id="profile">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="userData/ctrl.edit.teacher.php?facultyStaff_id=<?php echo $facultyStaff_id; ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <select class="form-control" name="status" id="status">
                                    <?php $getStatus = mysqli_query($db, "SELECT * FROM tbl_faculties_staff WHERE faculty_id = '$facultyStaff_id'");
                ...
                <form class="card mt-4 mb-5" id="password" method="POST" action="userData/ctrl.edit.teacher.php?facultyStaff_id=<?php echo $facultyStaff_id; ?>">
                    <div class="card-header">
