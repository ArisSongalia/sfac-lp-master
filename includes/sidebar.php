...
<li class="nav-item">
        ...
        <li class="nav-item">
                ...
                <div class="collapse" id="lists">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item">
                            <a class="nav-link" href="../admission/add.announcement.php">
                                <span class="sidenav-mini-icon"> </span>
                                <span class="sidenav-normal font-weight-bold">Add Announcement</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="../admission/list.announcement.php">
                                <span class="sidenav-mini-icon"> </span>
                                <span class="sidenav-normal font-weight-bold">Announcement List</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="../permit/student.permit.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-alt text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">Student Permit</span>
                </a>
            </li>
            ';
            ...
            <div class="collapse" id="enrollment">
                <ul class="nav ms-4 ps-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../enrollment/enrollment.history.php">
                            <span class="sidenav-mini-icon"> </span>
                            <span class="sidenav-normal font-weight-bold">Enrollment History</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <div class="collapse" id="lists">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../teacher/list.teacher.php">
                                <span class="sidenav-mini-icon text-xs"> </span>
                                <span class="sidenav-normal font-weight-bold">Teacher List</span>
                            </a>
                        </li>
                        <li class="nav-item">
        ...
        ';
                    ...
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../permit/student.permit.php">
                                ...
                                <span class="sidenav-normal font-weight-bold">Permit</span>
                            </a>
                        </li>
            ...
            <li class="nav-item">
                <a href="../curriculum/search.curri.php" class="nav-link"
                    role="button" aria-expanded="false">
                    <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="curriculum">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" aria-expanded="false" href="#newcurri23">
                                <span class="sidenav-mini-icon"> </span>
                                <span class="sidenav-normal font-weight-bold">2023_Curriculum</span>
                            </a>
                            <div class="collapse" id="newcurri23">
                                <ul class="nav nav-sm flex-column">

                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BA-PSY.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BA PSYC</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BEED-laspi.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BEED</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BSED-Filipino-laspi.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BSED-Filipino</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BSED-Math-laspi.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BSED-Math</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BSED-English-laspi.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BSED-English</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BSED-Science-laspi.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BSED-Science</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BSED-SE-laspi.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BSED-SE</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
    ...
    <div class="sidenav-footer mx-3">
        ...
        <?php if ("Super Administrator" == $_SESSION['role']) {
            ...
            if ($_SESSION['userid'] == 17 || $_SESSION['userid'] == 9 || $_SESSION['userid'] == 3 || $_SESSION['userid'] == 4) {
