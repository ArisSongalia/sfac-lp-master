                        ...
                        <div class="card-header">
                            <form method="GET">
                                <div class="row">
                                    ...
                                    <div class="col-md-3  g-0 mt-3 px-1 my-lg-0">
                                        <div class="my-auto">
                                        ...
                                        <div class="my-auto">
                                            <select class="form-control" name="eay" id="academic_year">
                                                ...
                                                if (!empty($_GET['eay']) && $count > 0) {
                                                    ...
                                                    echo '<option selected  value="">Select Curriculum
                                                        </option>';
                                ...
                                <tbody>
                                    ...
                                    if (!empty($_GET['CID']) && $count1 > 0) {
                                        if (!empty($_GET['eay'])) {
                                            ...
                                            WHERE SN.course_id = '$_GET[CID]' AND eay = '$_GET[eay]' AND semester = '$_GET[semester]'") or die($db->error);
                                        } else {
                                            $listSubjects = mysqli_query($db, "SELECT * FROM tbl_subjects_new SN
                                                LEFT JOIN tbl_year_levels YL ON YL.year_id = SN.year_id
                                                LEFT JOIN tbl_semesters S ON S.sem_id = SN.sem_id
                                                LEFT JOIN tbl_effective_acadyear EA ON EA.eay_id = SN.eay_id
                                                LEFT JOIN tbl_courses C USING(course_id)
                                                WHERE SN.course_id = '$_GET[CID]' AND eay = '0' AND semester = '0'") or die($db->error);
                                        }
                                    } else {
                                        $listSubjects = mysqli_query($db, "SELECT * FROM tbl_subjects_new SN
                                                LEFT JOIN tbl_year_levels YL ON YL.year_id = SN.year_id
                                                ...
                                                LEFT JOIN tbl_effective_acadyear EA ON EA.eay_id = SN.eay_id
                                                LEFT JOIN tbl_courses C USING(course_id)
                                                WHERE SN.course_id = '0' AND eay = '0' AND semester = '0'") or die($db->error);
                                    }
                                                                ...
                                                                <div class="col-lg-11 col-12 mx-auto">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <select class="form-control multi" name="semester" id="multi_sem<?php echo $m; ?>">
                                                                               <option value="" selected disabled>
                                                                                    Select Semester
                                                                                </option>
                                                                                    <?php
                                                                                    $select_sem = mysqli_query($db, "SELECT * FROM tbl_semesters");
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <select class="form-control multi" name="acad_year" id="multi_ay<?php echo $m; ?>">
                                                                                    <option value="" selected disabled>
                                                                                    Select Academic Year
                                                                                </option>
                                                                                    ?>
                                                                                    <?php
                                                                                    $select_ay = mysqli_query($db, "SELECT * FROM tbl_acadyears");
