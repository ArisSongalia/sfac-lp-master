...
?>
<title>  
    Registrars List | SFAC - Las Piñas
</title>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View Registrar List</h6>
                ...
                <div class="col-12">
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header">
                            <h5 class="mb-0">Registrar List</h5>
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover nowrap responsive" id="datatable-basic">
                                ...
                                <tbody>
                                    <?php
                                    $listadmin = mysqli_query($db, "SELECT *, CONCAT(tbl_admins.admin_lastname, ', ', tbl_admins.admin_firstname, ' ', tbl_admins.admin_middlename) AS fullname FROM tbl_admins");
                                    while ($row = mysqli_fetch_array($listadmin)) {
                                        $id = $row['admin_id'];
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['admin_lastname']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['admin_firstname']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['admin_middlename']; ?></td>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <a class="btn bg-gradient-primary text-xs"
                                                href="edit.registrar.php?admin_id=<?php echo $id; ?>"><i
                                        ...
                                        <div class="modal-dialog modal-danger modal-dialog-centered modal-"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="userData/ctrl.del.registrar.php?admin_id=<?php echo $id; ?>"
