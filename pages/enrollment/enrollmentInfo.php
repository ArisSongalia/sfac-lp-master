                ...
                <div class="col-lg-11 col-12 mx-auto">
                    ...
                    <div class="card card-body blur shadow-blur mx-4 mt-n5 overflow-hidden">
                        ...
                        <div class="row gx-4 justify-content-evenly">
                            ...
                            <p class="mt-3">To visit our Schoology log in page, <b><a href="http://stfrancis.schoology.com/">click here.</a></b></p>
                    ...
                    <div class="card card-body mt-4 shadow-sm">
                        ...
                        <form method="POST" action="userData/ctrl.enrollmentInfo.php">
                            ...
                            <div class="row">
                                <p class="mt-3"><b>Click here:</b> <a href="http://stfrancis.schoology.com/">Schoology Link</a></b></p>
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        $query1 = $db->query("SELECT * FROM tbl_schedules S
                                                                            ...
                                                                            WHERE S.subj_id NOT IN (SELECT ES.subj_id FROM tbl_enrolled_subjects ES WHERE ES.stud_id = '$stud_id' AND ES.acad_year = '$_SESSION[AC]' AND ES.semester = '$_SESSION[S]') AND C.course_id = '$course_id' AND acad_year = '$_SESSION[AC]' AND S.semester = '$_SESSION[S]' AND S.room_status = 0
